...
Public Class TrabajoRealizado
    ...
    Private Sub Poblar()
        ...
        Dim da As New MySqlDataAdapter("CALL CallTrabajos('" & txtBuscar.Text & "',1,1)", Conexiones.Cnn)
    ...
    Protected Sub btnID_Click(sender As Object, e As EventArgs) Handles btnID.Click
        ...
        Dim da As New MySqlDataAdapter("CALL TrabajoByID('" & txtID.Text & "',1,1)", Conexiones.Cnn)
    ...
    Protected Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        If CBFinal.Checked = True Then
            final = 1
            'lFinal.Text = "Finalizado " + final.ToString
        ...
        If txtID.Text = "0" Or txtID.Text = "" Then
            Dim cmd As New MySqlCommand("INSERT INTO `trabajorealizado`(`ID_EMPRESA`, `ID_SUCURSAL`, `ID_CLIENTE`, `ID_EMPLEADO`, `ID_USUARIO`, `FECHA`, `DESCRIPCION`, `TIPOTRABAJO`, `FINALIZADO`, `ACTIVO`) 
                                     ...
                                     "','" & txtFecha.Text & "','" & txtDescripcion.Text & "',b'" & ttrabajo & "',b'" & final & "',b'1')", Conexiones.Cnn)
            cmd.ExecuteNonQuery()
