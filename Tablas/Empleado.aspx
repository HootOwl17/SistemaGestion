<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Empleado.aspx.vb" Inherits="SistemaGestion.Empleado" %>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td class="auto-style8">NOMBRE(S)</td>
                                            <td class="auto-style2">
                                        ...
                                        <tr>
                                            <td class="auto-style8">APELLIDO(S)</td>
                                            <td class="auto-style2">
                                                <asp:TextBox ID="txtApellido" runat="server" Width="215px"></asp:TextBox>
                                            </td>
                                            <td class="auto-style5">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td class="auto-style2">
                                                <asp:DropDownList ID="ddlSucursal" runat="server" Width="215px" AutoPostBack="True">
                                    ...
                                    <asp:GridView ID="empleadoGrid" runat="server" AutoGenerateColumns="False" Width="900px" class="table table-bordered" >
                                        <Columns>
