<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PagosHistorial.aspx.vb" Inherits="SistemaGestion.PagosHistorial" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabla de Historial de Pagos</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="bitacoraGrid" runat="server" AutoGenerateColumns="False" Width="900px" class="table table-bordered" >
                                        <Columns>
                                            <asp:BoundField DataField="ID_PAGO" HeaderText="N° MOVIMIENTO" />
                                            <asp:BoundField DataField="ID_FACTURA" HeaderText="ID FACTURA" />
                                            <asp:BoundField DataField="N_PAGO" HeaderText="N° ACTUALIZACIÓN" />
