<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Facturacion.aspx.vb" Inherits="SistemaGestion.Facturacion" %>
            ...
            <div id="content">
                ...
                <form runat="server" id="formEmpresa" class="auto-style7">
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">FACTURACIÓN</h1>
                        <%--<p class="mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabla de Facturas</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">
                                                <asp:DropDownList ID="ddlEmpresa" runat="server" Width="215px" AutoPostBack="True" Enabled="False">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">
                                                <asp:DropDownList ID="ddlSucursal" runat="server" Width="215px" AutoPostBack="True" ValidationGroup="" Enabled="False">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">
                                                <asp:DropDownList ID="ddlEmpleado" runat="server" Width="215px" AutoPostBack="True" Enabled="False">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">
                                                <asp:DropDownList ID="ddlCliente" runat="server" Width="215px" AutoPostBack="True" Enabled="False">
                                        ...
                                        <tr>
                                            <td class="auto-style8">COD_PAGO</td>
                                            <td class="auto-style2">
                                                <asp:TextBox ID="txtPago" runat="server" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td class="auto-style5">
                                        ...
                                        <tr>
                                            <td class="auto-style8">TRABAJO</td>
                                            <td class="auto-style2">
                                                <asp:DropDownList ID="ddlTrabajo" runat="server" Width="215px" AutoPostBack="True" Enabled="False">
                                         ...
                                         <tr>
                                            <td class="auto-style8">TIPO DE PAGO</td>
                                            <td class="auto-style2">
                                                <asp:RadioButton ID="RBContado" runat="server" GroupName="tipoPago" Text="Contado" AutoPostBack="True" /><br />
                                                <asp:RadioButton ID="RBCredito" runat="server" GroupName="tipoPago" Text="Credito" AutoPostBack="True" />
                                            </td>
                                            <td class="auto-style5">
                                                &nbsp;</td>
                                            <td class="auto-style4">&nbsp;</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2">
                                                <asp:Calendar ID="Calendar1" runat="server" Width="215px" Enabled="False"></asp:Calendar>
                                                <asp:TextBox ID="txtFecha" runat="server" Width="215px" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td class="auto-style5">
                                                <asp:Label ID="txtSentencia" runat="server" Text="Label" Visible="False"></asp:Label>
                                            </td>
                                            <td class="auto-style4">&nbsp;</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td class="auto-style8">PAGO ABONADO</td>
                                            <td class="auto-style2">
                                                <asp:TextBox ID="txtAbonado" runat="server" Width="215px"></asp:TextBox>
                                                <asp:Label ID="txtEstadoPago" runat="server" Text="Estado" Visible="False"></asp:Label>
                                            </td>
                                            <td class="auto-style5">
                                                &nbsp;</td>
                                            <td class="auto-style4">&nbsp;</td>
                                        ...
                                        <tr>
                                            <td class="auto-style8">PAGO NETO</td>
                                            <td class="auto-style2">
                                                <asp:TextBox ID="txtNeto" runat="server" Width="215px"></asp:TextBox>
                                            </td>
                                            <td class="auto-style5">
                                        ...
                                        <tr>
                                            <td class="auto-style8">IVA (13%)</td>
                                            <td class="auto-style2">
                                                <asp:TextBox ID="txtIVA" runat="server" Width="215px" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td class="auto-style5">
                                                &nbsp;</td>
                                            <td class="auto-style4">&nbsp;</td>
                                        ...
                                        <tr>
                                            <td class="auto-style8">PAGO TOTAL</td>
                                            <td class="auto-style2">
                                                <asp:TextBox ID="txtTotal" runat="server" Width="215px" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td class="auto-style5">
                                                &nbsp;</td>
                                            <td class="auto-style4">&nbsp;</td>
                                    ...
                                    <asp:GridView ID="facturaGrid" runat="server" AutoGenerateColumns="False" Width="900px" class="table table-bordered" >
                                        <Columns>
