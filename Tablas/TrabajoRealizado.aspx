<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TrabajoRealizado.aspx.vb" Inherits="SistemaGestion.TrabajoRealizado" %>
            ...
            <div id="content">
                ...
                <form runat="server" id="formEmpresa" class="auto-style7">
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Trabajos Realizados</h1>
                        <%--<p class="mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabla de Trabajos Realizados</h6>
                            </div>
                            <div class="card-body">
